...
function chalkboard(){
	...
	$('#test').prepend('<div class="panel"><a class="link" target="_blank">Save</a></div>');
	$('#test').prepend('<img src="img/bg.png" id="pattern" width=50 height=50>');
	$('#test').prepend('<canvas id="chalkboard"></canvas>');
	$('#test').prepend('<div class="chalk"></div>');

	var canvas = document.getElementById("chalkboard");
	$('#chalkboard').css('width',$('#test').width());
	$('#chalkboard').css('height',$('#test').height());
